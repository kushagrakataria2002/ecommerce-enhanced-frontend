                                ...
                                <div className="flex flex-wrap -mx-4">
                                    ...
                                    <div className="w-full md:w-1/3 px-4 mb-8">
                                        <img
                                            src={result.image}
                                            alt={result.title}
                                            className="w-full h-auto mx-auto rounded-lg shadow-md mb-4"
                                            id="mainImage"
                                        />
                                    </div>
                                    {/* Product Details */}
                                    <div className="w-full md:w-1/2 px-4">
                                        ...
                                        <p className="text-gray-600 mb-4">{result.category}</p>
                                        <div className="mb-4">
                                            <span className="text-2xl font-bold mr-2 ">₹{result.price}</span>
                                        </div>
                                        <div className="flex items-center mb-4">
                                            <span className=" text-gray-600">{`${result.rating.count} reviews`}</span>
                                        </div>
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <div className='w-12 text-center rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'>1</div>
                                        </div>
                                        <div className="flex space-x-4 mb-6">
                                            ...
                                            >
                                                ...
                                                <IoCartSharp className='text-2xl text-red-500 ml-2' />
                                            </button>
